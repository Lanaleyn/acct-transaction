...
if (isset($btnSubmit)) {
	$databasecfg->addTrans($txtDate, $txtDesc, $radioDecr, $txtAmount, $txtBalance);
}

if(isset($btnUpdate)){
	$databasecfg->updateTrans($txtDate, $txtDesc, $radioDecr, $txtAmount, $txtBalance);
}
							...
							<form id="submissionform" method="POST">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-3">
										...
										<input type="text" class="form-control" name="txtAmount" placeholder="e.g. 12345.67" required>
									</div>
